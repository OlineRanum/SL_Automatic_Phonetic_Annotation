...
def main(args):
    """
    Main script to process the input folder and execute necessary functions.
    """
    # Convert to HaMer
    ...
    try:
        ...
        print("Please start the HAMER server first.")
    ...
    for base_filename in base_filenames:
        ...
        gif_path = '/home/gomer/oline/PoseTools/src/modules/server/public/gifs/'+base_filename+'.gif'
        ...
        handshape_predictions= main_handshape(data, input_folder + '/hamer_pkl', output_folder, boolean_arrays=boolean_activity_arrays, base_filename='normalized_' +base_filename, transformation=args.feature_transformation)
