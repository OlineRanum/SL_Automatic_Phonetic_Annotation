...
class BuildReferencePose:
    def __init__(self, pose_dir, predefined_poses = None, gloss_map_path = '/home/gomer/oline/PoseTools/data/metadata/output/global_value_to_id.txt'):
...
if __name__ == "__main__":
    ...
    for i in range(1, num_iterations + 1):
        ...
        if i == 1:
            ...
            poseconstructor = BuildReferencePose(pose_dir, predefined_poses=predefined_poses)
            
        reference_poses = poseconstructor.build_reference_pose(df)
        
        # Update the predefined poses for the next iteration
        predefined_poses = reference_poses

        # Save the reference poses from the last iteration
        if i == num_iterations:
            output_path = f'/home/gomer/oline/PoseTools/src/modules/handshapes/utils/references/iteration_{i}.png'
            plot_multiple_hands_from_dict(reference_poses, output_path=output_path)
            save_path = f'/home/gomer/oline/PoseTools/src/modules/handshapes/utils/references/reference_poses_it{i}.pkl'
