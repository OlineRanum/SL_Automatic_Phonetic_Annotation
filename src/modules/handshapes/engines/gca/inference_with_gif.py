...
#handshape_labels = ['1', '2', '3', '4', '9', '12', '17', '18','19', '22', '23', '25', '27', '36','37','38',  '41', '42', '43', '44']
#handshape_labels = ["T", "B", "1", "C", "S"]
handshape_labels = ['A', 'B', 'C', '1', 'N', 'L', 'S', 'T', 'V', '1_curved', 'Y', '5', 'B_bent', 'Money', 'C_spread', 'B_curved', 'V_curved', 'Beak', '5m', 'Baby_C']
...
def load_model(model_path, device):
    ...
    """
    model = HandshapeGAT(in_channels=3, hidden_channels=128, out_channels=20, heads=8)
...
def process_directory(input_folder, model, device):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith('.pkl'):  # Only process .pkl files
            ...
            output_gif_path = os.path.join(input_folder, f"gif/{os.path.splitext(filename)[0]}_output_newmodel.gif")
            ...
            print(f"File: {filename} - Predicted Handshape: {predicted_class_idx}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', default='/home/gomer/oline/PoseTools/src/models/graphTransformer/trained_models/20c_newpre_200_87.pth',
