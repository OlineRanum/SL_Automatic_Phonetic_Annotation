...
class Evaluate2APoses:
    ...
    def evaluate_poses(self):
        ...
        with open(output_file, 'w') as f_out:
            for index, row in self.df.iterrows():
                ...
                if os.path.exists(video_id_L):
                    ...
                    if hand_L == 'h1':
                        hand_L = self.get_key_from_value(h1)
                    elif hand_L == 'h2':
                        hand_L = self.get_key_from_value(h2)
                    else:
                        hand_L = None
                ...
                if os.path.exists(video_id_R):
                    ...
                    if hand_R == 'h1':
                        hand_R = self.get_key_from_value(h1)
                    elif hand_R == 'h2':
                        hand_R = self.get_key_from_value(h2)
                    else:
                        hand_R = None
        ...
        print(f"Total errors: {error / total_rows}")
