...
input_folder = "/mnt/fishbowl/gomer/oline/sb_uva/hamer"
output_folder = "/mnt/fishbowl/gomer/oline/sb_uva/hamer_pkl"
...
fc.to_pkl(input_folder, output_folder, dict_file, external_dict_file, pose_type = 'hamer')
